...
class ActivityService:
    ...
    def get_activity(self, activity_id: uuid.UUID) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Failed to get activity {activity_id}: {response.status_code}")
                return None
    ...
    def update_activity(
        ...
        """
        try:
            response = self.client.put(f"{self.base_path}/{activity_id}", json=activity_data)
    ...
    def get_activity_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Failed to get activity statistics: {response.status_code}")
                return {}
    ...
    def find_similar_activities(
        ...
        try:
            ...
            response = self.client.get(
                f"{self.base_path}/{activity_id}/similar",
                params=params
            )
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Failed to find similar activities: {response.status_code}")
                return []
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return [
                    ...
                    "Projects", "Manufacturing", "HR", "Payroll",
                    "Assets", "Support", "Website", "E Commerce"
                ]
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return [
                    ...
                    "search", "filter", "export", "import", "approve",
                    "submit", "cancel", "validate", "calculate"
                ]
    ...
    def bulk_operations(
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                st.success(f"Bulk operation completed: {result.get('processed', 0)} activities")
                # Clear cache
                self.list_activities.clear()
                return result
            else:
...
class PersonaActivityService:
    ...
    def list_persona_activities(
        ...
        try:
            ...
            response = self.client.get(f"/personas/{persona_id}/activities", params=params)
    ...
    def link_persona_to_activity(
        ...
        try:
            ...
            response = self.client.post(
                f"/personas/{persona_id}/activities/{activity_id}",
                json=link_data
            )
    ...
    def get_activity_recommendations(
        ...
        try:
            ...
            response = self.client.get(
                f"/personas/{persona_id}/activities/recommendations",
                params=params
            )
