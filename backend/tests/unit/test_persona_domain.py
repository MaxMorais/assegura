...
from src.domain.personas.erpnext_roles import ERPNextRole, ERPNextRoleValidator
...
class TestPersonaDomainEntity:
    ...
    def test_persona_remove_erpnext_role(self):
        ...
        persona = Persona(
            name="Test User",
            erpnext_roles=["User", "Sales Manager", "Customer"]
        )
    ...
    def test_persona_remove_erpnext_role_validation(self):
        ...
        persona = Persona(
            name="Test User",
            erpnext_roles=["User"]  # Only one role
        )
...
class TestPersonaDomainService:
    ...
    def test_validate_persona_update_success(self):
        ...
        updated_persona = Persona(
            name="Updated Name",
            erpnext_roles=["User", "Sales Manager"]
        )
    ...
    def test_validate_persona_permissions(self):
        ...
        assert result is False or isinstance(result, dict)  # Could return validation details
    ...
    def test_merge_personas(self):
        ...
        merged_persona = service.merge_personas(persona1, persona2, "Merged Sales Manager")
