...
class TestActivityAPI:
    ...
    def test_create_activity_success(self):
        ...
        assert (
            response_data["estimated_duration"] == activity_data["estimated_duration"]
        )
    ...
    def test_update_activity(self):
        ...
        assert (
            updated_activity["estimated_duration"] == update_data["estimated_duration"]
        )
    ...
    def test_update_activity_not_found(self):
        ...
        response = self.client.put(
            f"{self.base_url}/{non_existent_id}", json=update_data
        )
        assert response.status_code == 404
    ...
    def test_search_activities(self):
        ...
        activities = [
            {
                "name": "Customer Management Activity",
