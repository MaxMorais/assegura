...
from ...domain.personas import (
    Persona,
    PersonaService as PersonaDomainService,
...
class PersonaService:
    ...
    async def update_persona(self, persona_id: UUID, request: PersonaUpdateRequest) -> PersonaResponse:
    ...
    async def validate_persona_data(self, request: PersonaCreateRequest) -> PersonaValidationResponse:
        ...
        if len(roles) == 1:
            suggestions.append("Consider if this persona needs additional roles for complete functionality")
    ...
    async def get_persona_suggestions(self, request: PersonaSuggestionRequest) -> PersonaSuggestionResponse:
    ...
    async def find_similar_personas(self, persona_id: UUID, similarity_threshold: float = 0.7) -> List[PersonaSummaryResponse]:
    ...
    def _apply_updates(self, persona: Persona, request: PersonaUpdateRequest) -> Persona:
