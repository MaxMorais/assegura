...
class ActionParameterSchema(BaseModel):
    ...
    # ERPNext specific
    erpnext_field: Optional[str] = Field(None, description="Corresponding ERPNext field")
...
class ActionParameterUpdateSchema(BaseModel):
    ...
    param_type: Optional[ParameterTypeEnum] = Field(None, description="Updated parameter type")
...
class ActionOutputSchema(BaseModel):
    ...
    extraction_rule: Optional[str] = Field(None, description="Extraction rule (XPath, JSON path, regex)")
    aggregation: Optional[str] = Field(None, description="Aggregation method (sum, count, avg)")
...
class ActionOutputUpdateSchema(BaseModel):
    ...
    output_type: Optional[ParameterTypeEnum] = Field(None, description="Updated output type")
    description: Optional[str] = Field(None, description="Updated description")
    required: Optional[bool] = Field(None, description="Updated required flag")
...
class ActionBaseSchema(BaseModel):
    ...
    description: str = Field(..., min_length=10, max_length=1000, description="Action description")
    action_type: ActionTypeEnum = Field(..., description="BDD action type")
    implementation_type: ImplementationTypeEnum = Field(..., description="Implementation type")
    ...
    is_deprecated: bool = Field(default=False, description="Whether action is deprecated")
...
class ActionUpdateSchema(BaseModel):
    ...
    action_type: Optional[ActionTypeEnum] = Field(None, description="Updated action type")
    implementation_type: Optional[ImplementationTypeEnum] = Field(None, description="Updated implementation type")
    erpnext_module: Optional[str] = Field(None, description="Updated ERPNext module")
    execution_timeout: Optional[int] = Field(None, ge=1, le=3600, description="Updated timeout")
    retry_count: Optional[int] = Field(None, ge=0, le=10, description="Updated retry count")
    tags: Optional[List[str]] = Field(None, description="Updated tags")
    category: Optional[str] = Field(None, description="Updated category")
    robot_keywords: Optional[List[str]] = Field(None, description="Updated Robot keywords")
    robot_library: Optional[str] = Field(None, description="Updated Robot library")
    documentation_url: Optional[str] = Field(None, description="Updated documentation URL")
    examples: Optional[List[str]] = Field(None, description="Updated examples")
    is_active: Optional[bool] = Field(None, description="Updated active status")
    is_deprecated: Optional[bool] = Field(None, description="Updated deprecation status")
...
class ActionUsageStatsSchema(BaseModel):
    ...
    common_parameters: Dict[str, Any] = Field(..., description="Most common parameter values")


class ActionResponseSchema(ActionBaseSchema, BaseResponseSchema):
    """Schema for action API responses."""
    
    parameters: List[ActionParameterSchema] = Field(..., description="Action parameters")
    expected_outputs: List[ActionOutputSchema] = Field(..., description="Expected outputs")
...
class ActionFilterSchema(BaseModel):
    ...
    action_type: Optional[ActionTypeEnum] = Field(None, description="Filter by action type")
    ...
    has_robot_integration: Optional[bool] = Field(None, description="Filter by Robot Framework integration")
    min_parameters: Optional[int] = Field(None, ge=0, description="Minimum parameter count")
    max_parameters: Optional[int] = Field(None, ge=0, description="Maximum parameter count")
    complexity_level: Optional[str] = Field(None, description="Filter by complexity level")
    text_search: Optional[str] = Field(None, description="Text search in name/description/tags")
...
class ActionBulkOperationSchema(BaseModel):
    ...
    action_ids: List[UUID] = Field(..., min_items=1, max_items=100, description="Action IDs")
    operation: str = Field(..., regex="^(activate|deactivate|deprecate|delete|tag)$", description="Operation")
...
class ActionLibraryStatsSchema(BaseModel):
    ...
    action_type_distribution: Dict[str, int] = Field(..., description="Distribution by action type")
    implementation_type_distribution: Dict[str, int] = Field(
        ..., description="Distribution by implementation type"
    )
    module_distribution: Dict[str, int] = Field(..., description="Distribution by ERPNext module")
    avg_parameters_per_action: float = Field(..., description="Average parameters per action")
    most_used_actions: List[ActionListItemSchema] = Field(..., description="Most used actions")
    recently_created: List[ActionListItemSchema] = Field(..., description="Recently created actions")
