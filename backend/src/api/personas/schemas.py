    ...
    SUGGESTION_RESPONSE = {
        "suggestions": [
            ...
            },
            {
                ...
                "permissions": [
                    "read_stock_reconciliation",
                    "write_stock_reconciliation",
                ],
                "confidence": 0.87,
...
class PersonaAPISchemas:
    ...
    class ValidationError(BaseModel):
        ...
        errors: list["PersonaAPISchemas.ErrorDetail"] = Field(
...
__all__ = ["PersonaAPIExamples", "PersonaAPIDocumentation", "PersonaAPISchemas"]
