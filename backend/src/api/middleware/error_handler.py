...
class ErrorHandlingMiddleware:
    ...
    async def __call__(self, request: "Request", call_next: Callable) -> "Response":
        ...
        try:
            ...
            return await self._handle_pydantic_validation_error(request, exc, request_id)
...
class ErrorHandlingHTTPMiddleware(BaseHTTPMiddleware if 'BaseHTTPMiddleware' in globals() else object):
