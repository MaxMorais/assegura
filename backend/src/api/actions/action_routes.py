...
from ...application.dto.action_schemas import (
    ...
    ActionValidationResultSchema, ActionComplexityScoreSchema,
    ActionUsageStatsSchema, ActionPatternSchema, ActionSuggestionSchema,
    ActionBulkOperationSchema, ActionBulkResultSchema,
...
async def list_actions(
    ...
    implementation_type: Optional[str] = Query(None, description="Filter by implementation type"),
    ...
    filters = ActionFilterSchema(
        ...
        implementation_type=ImplementationType(implementation_type) if implementation_type else None,
...
async def action_library_health(
    service: ActionLibraryService = Depends(get_service)
):
