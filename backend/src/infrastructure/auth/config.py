...
from .services import AuthenticationService, PasswordService, TokenService
...
class AuthConfig:
    ...
    def __init__(self) -> None:
        ...
        self.require_password_complexity = (
        ...
        self.remember_me_expire_days = int(os.getenv("REMEMBER_ME_EXPIRE_DAYS", "30"))
...
class AuthServiceFactory:
    ...
    def create_auth_dependencies(
        self, get_consultant_by_id: callable, get_tenant_by_id: callable
    ) -> dict:
