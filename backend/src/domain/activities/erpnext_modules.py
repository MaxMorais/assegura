...
class ERPNextModuleValidator:
    ...
    MODULE_DOCTYPES = {
        ERPNextModule.ACCOUNTS.value: [
            "Account", "Journal Entry", "Payment Entry", "Sales Invoice", 
            "Purchase Invoice", "Payment Request", "Payment Terms", "Payment Term",
            "Accounting Dimension", "Cost Center", "Budget", "Fiscal Year",
            "Period Closing Voucher", "Bank", "Bank Account", "Currency",
            "Exchange Rate Revaluation", "Loyalty Program", "Pricing Rule"
        ],
        ERPNextModule.SELLING.value: [
            "Customer", "Sales Order", "Quotation", "Sales Invoice",
            "Delivery Note", "Sales Partner", "Customer Group", "Territory",
            "Sales Person", "Campaign", "Lead", "Opportunity", "Installation Note",
            "Product Bundle", "Blanket Order", "Contract"
        ],
        ...
        ERPNextModule.BUYING.value: [
            "Supplier", "Purchase Order", "Request for Quotation", "Supplier Quotation",
            "Purchase Invoice", "Purchase Receipt", "Material Request",
            "Supplier Group", "Purchase Taxes and Charges Template", "Blanket Order"
        ],
        ERPNextModule.STOCK.value: [
            "Item", "Item Group", "Warehouse", "Stock Entry", "Stock Reconciliation",
            "Delivery Note", "Purchase Receipt", "Material Request", "Item Price",
            "Price List", "UOM", "Brand", "Batch", "Serial No", "Quality Inspection",
            "Packing Slip", "Installation Note", "Landed Cost Voucher"
        ],
        ERPNextModule.MANUFACTURING.value: [
            "BOM", "Work Order", "Production Plan", "Job Card", "Routing",
            "Operation", "Workstation", "Item Alternative", "Sub Assembly Item"
        ],
        ERPNextModule.CRM.value: [
            "Lead", "Customer", "Opportunity", "Campaign", "Newsletter",
            "Email Group", "Contact", "Address", "Communication",
            "Phone Call", "Appointment", "Contract"
        ],
        ERPNextModule.SUPPORT.value: [
            "Issue", "Warranty Claim", "Maintenance Schedule", "Maintenance Visit"
        ],
        ERPNextModule.PROJECTS.value: [
            "Project", "Task", "Timesheet", "Project Template", "Project Type",
            "Activity Type", "Activity Cost"
        ],
        ERPNextModule.HR.value: [
            "Employee", "Employee Group", "Designation", "Department", "Branch",
            "Holiday List", "Leave Type", "Leave Application", "Leave Allocation",
            "Attendance", "Employee Checkin", "Shift Type", "Shift Request",
            "Shift Assignment", "Employee Onboarding", "Employee Separation",
            "Employee Transfer", "Employee Promotion", "Employee Skill Map",
            "Training Program", "Training Event", "Training Result", "Training Feedback",
            "Appraisal", "Employee Grade", "Employment Type", "Health Insurance",
            "Employee Advance", "Expense Claim", "Travel Request"
        ],
        ERPNextModule.PAYROLL.value: [
            "Salary Structure", "Salary Slip", "Payroll Entry", "Salary Component",
            "Additional Salary", "Retention Bonus", "Income Tax Slab", "Employee Tax Exemption Declaration",
            "Employee Tax Exemption Proof Submission", "Employee Benefit Application",
            "Employee Benefit Claim", "Payroll Period"
        ],
        ERPNextModule.ASSETS.value: [
            "Asset", "Asset Category", "Asset Movement", "Asset Maintenance",
            "Asset Repair", "Asset Value Adjustment", "Asset Depreciation Schedule",
            "Location"
        ],
        ERPNextModule.QUALITY.value: [
            "Quality Inspection", "Quality Inspection Template", "Quality Goal",
            "Quality Procedure", "Quality Meeting", "Quality Review", "Quality Feedback"
        ],
        ERPNextModule.WEBSITE.value: [
            "Website Settings", "Web Page", "Web Form", "Blog Post", "Blog Category",
            "Blogger", "Website Slideshow", "Website Script", "Website Theme"
        ],
        ERPNextModule.SETUP.value: [
            "Company", "Global Defaults", "System Settings", "Print Settings",
            "Email Account", "Email Domain", "Letter Head", "Address Template",
            "Terms and Conditions", "Quotation Lost Reason", "Sales Stage",
            "Opportunity Type", "Fiscal Year", "Currency", "Customer Group",
            "Territory", "Sales Person", "Item Group", "UOM", "Brand"
        ],
        ERPNextModule.CONTACTS.value: [
            "Contact", "Address", "Contact Phone", "Contact Email"
        ],
        ERPNextModule.COMMUNICATION.value: [
            "Communication", "Email Queue", "Email Template", "Newsletter",
            "Notification", "SMS Settings", "SMS Log"
        ]
    }
    ...
    @classmethod
    def suggest_modules_for_activity(cls, activity_description: str, action_type: str) -> List[Dict[str, any]]:
        ...
        module_keywords = {
            ERPNextModule.SELLING.value: [
                "sales", "customer", "quotation", "order", "invoice", "delivery", 
                "opportunity", "lead", "campaign", "territory"
            ],
            ERPNextModule.BUYING.value: [
                "purchase", "supplier", "procurement", "buying", "quotation", 
                "material request", "receipt"
            ],
            ERPNextModule.STOCK.value: [
                "inventory", "warehouse", "item", "stock", "material", "batch", 
                "serial", "quality inspection"
            ],
            ERPNextModule.ACCOUNTS.value: [
                "accounting", "finance", "payment", "journal", "budget", "cost center",
                "fiscal year", "chart of accounts"
            ],
            ERPNextModule.HR.value: [
                "employee", "hr", "human resource", "payroll", "attendance", 
                "leave", "appraisal", "recruitment"
            ],
            ERPNextModule.CRM.value: [
                "customer relationship", "contact", "communication", "newsletter",
                "email group", "phone call"
            ],
            ERPNextModule.PROJECTS.value: [
                "project", "task", "timesheet", "milestone", "gantt"
            ],
            ERPNextModule.MANUFACTURING.value: [
                "production", "manufacturing", "bom", "work order", "routing",
    ...
    @classmethod
    def validate_activity_module_compatibility(cls, module: str, doctype: str, action_type: str) -> Dict[str, any]:
        ...
        # Check if doctype is valid for the module
            ...
            result["warnings"].append(f"DocType '{doctype}' is not typically associated with module '{module}'")
        ...
        write_actions = ["create", "update", "delete", "import", "approve", "cancel", "submit"]
        
        if action_type in readonly_actions:
            result["warnings"].append(f"Action '{action_type}' is read-only and may not require extensive validation")
        elif action_type in write_actions:
            if module in [ERPNextModule.SETUP.value, ERPNextModule.CORE.value]:
                result["warnings"].append(f"Write operations on {module} module require admin privileges")
...
class ERPNextDocTypeHelper:
    ...
    DOCTYPE_COMMON_FIELDS = {
        "Sales Order": [
            "customer", "delivery_date", "items", "taxes_and_charges", 
            "grand_total", "currency", "selling_price_list"
        ],
        "Purchase Order": [
            "supplier", "schedule_date", "items", "taxes_and_charges",
            "grand_total", "currency", "buying_price_list"
        ],
        "Customer": [
            "customer_name", "customer_type", "customer_group", 
            "territory", "default_currency"
        ],
        "Supplier": [
            "supplier_name", "supplier_type", "supplier_group",
        ...
        "Employee": [
            "employee_name", "first_name", "last_name", "designation",
    ...
    def suggest_validation_rules(cls, doctype: str, field: str) -> Dict[str, any]:
        ...
        elif field.endswith("_date") or field in ["date", "posting_date", "transaction_date"]:
            suggestions["required"] = True
