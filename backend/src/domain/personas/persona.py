...
class Persona(BaseEntity):
    ...
    def set_name(self, name: str) -> None:
        ...
        if len(name) < 2:
            raise PersonaValidationError("Persona name must be at least 2 characters long")
    ...
    def set_description(self, description: str) -> None:
        ...
        if len(description) < 10:
            raise PersonaValidationError("Persona description must be at least 10 characters long")
        
        if len(description) > 2000:
            raise PersonaValidationError("Persona description must not exceed 2000 characters")
    ...
    def set_permissions(self, permissions: str) -> None:
        ...
        if len(permissions) > 1000:
            raise PersonaValidationError("Permissions string must not exceed 1000 characters")
    ...
    def remove_erpnext_role(self, role: str) -> bool:
        ...
        if len(self._erpnext_roles) <= 1:
            raise PersonaValidationError("Cannot remove role - persona must have at least one role")
    ...
    def has_permission(self, action: str, resource: str) -> bool:
        ...
        if f"admin:*" in permissions or f"admin:system" in permissions:
            return True
